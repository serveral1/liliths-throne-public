...
public class RacialBody {
	...
	public static AbstractRacialBody HUMAN = new AbstractRacialBody(
			...
			PenisType.HUMAN, 16, PenetrationGirth.TWO_AVERAGE, TesticleSize.TWO_AVERAGE, 2, CumProduction.THREE_AVERAGE,
	...
	public static AbstractRacialBody ANGEL = new AbstractRacialBody(
			...
			BodyMaterial.FLESH,
			HornLength.ZERO_TINY, HornLength.ZERO_TINY, Util.newArrayListOfValues(HornType.NONE),
			PenisType.ANGEL, 20, PenetrationGirth.TWO_AVERAGE,TesticleSize.THREE_LARGE, 2, CumProduction.SIX_EXTREME,
			Util.newArrayListOfValues(TailType.NONE),
			TentacleType.NONE,
	...
	public static AbstractRacialBody DEMON = new AbstractRacialBody(
			...
			PenisType.DEMON_COMMON, 25, PenetrationGirth.THREE_THICK, TesticleSize.THREE_LARGE, 2, CumProduction.SEVEN_MONSTROUS,
	...
	public static AbstractRacialBody COW_MORPH = new AbstractRacialBody(
			...
			PenisType.BOVINE, 27, PenetrationGirth.THREE_THICK, TesticleSize.THREE_LARGE, 2, CumProduction.FIVE_HUGE,
	...
	public static AbstractRacialBody DOG_MORPH = new AbstractRacialBody(
			...
			BodyMaterial.FLESH,
			HornLength.ZERO_TINY, HornLength.ZERO_TINY, Util.newArrayListOfValues(HornType.NONE),
			PenisType.CANINE, 19, PenetrationGirth.TWO_AVERAGE, TesticleSize.THREE_LARGE, 2, CumProduction.FOUR_LARGE,
	...
	public static AbstractRacialBody FOX_MORPH = new AbstractRacialBody(
			...
			BodyMaterial.FLESH,
			HornLength.ZERO_TINY, HornLength.ZERO_TINY, Util.newArrayListOfValues(HornType.NONE),
			PenisType.VULPINE, 17, PenetrationGirth.TWO_AVERAGE, TesticleSize.TWO_AVERAGE, 2, CumProduction.FOUR_LARGE,
	...
	public static AbstractRacialBody WOLF_MORPH = new AbstractRacialBody(
			...
			BodyMaterial.FLESH,
			HornLength.ZERO_TINY, HornLength.ZERO_TINY, Util.newArrayListOfValues(HornType.NONE),
			PenisType.LUPINE, 22, PenetrationGirth.THREE_THICK, TesticleSize.THREE_LARGE, 2, CumProduction.FIVE_HUGE,
	...
	public static AbstractRacialBody CAT_MORPH = new AbstractRacialBody(
			...
			BodyMaterial.FLESH,
			HornLength.ZERO_TINY, HornLength.ZERO_TINY, Util.newArrayListOfValues(HornType.NONE),
			PenisType.FELINE, 15, PenetrationGirth.TWO_AVERAGE, TesticleSize.TWO_AVERAGE, 2, CumProduction.THREE_AVERAGE,
	...
	public static AbstractRacialBody HORSE_MORPH = new AbstractRacialBody(
			...
			PenisType.EQUINE, 35, PenetrationGirth.FOUR_FAT, TesticleSize.FOUR_HUGE, 2, CumProduction.FIVE_HUGE, Util.newArrayListOfValues(TailType.HORSE_MORPH),
			TentacleType.NONE,
	...
	public static AbstractRacialBody REINDEER_MORPH = new AbstractRacialBody(
			...
			PenisType.REINDEER_MORPH, 28, PenetrationGirth.THREE_THICK, TesticleSize.THREE_LARGE, 2, CumProduction.THREE_AVERAGE,
	...
	public static AbstractRacialBody ALLIGATOR_MORPH = new AbstractRacialBody(
		    ...
		    BodyMaterial.FLESH,
			HornLength.ZERO_TINY, HornLength.ZERO_TINY, Util.newArrayListOfValues(HornType.NONE),
		    PenisType.ALLIGATOR_MORPH, 21, PenetrationGirth.THREE_THICK, TesticleSize.FOUR_HUGE, 2, CumProduction.FIVE_HUGE,
	...
	public static AbstractRacialBody SQUIRREL_MORPH = new AbstractRacialBody(
			...
			BodyMaterial.FLESH,
			HornLength.ZERO_TINY, HornLength.ZERO_TINY, Util.newArrayListOfValues(HornType.NONE),
			PenisType.SQUIRREL, 20, PenetrationGirth.THREE_THICK, TesticleSize.THREE_LARGE, 2, CumProduction.FOUR_LARGE,
	...
	public static AbstractRacialBody RAT_MORPH = new AbstractRacialBody(
			...
			BodyMaterial.FLESH,
			HornLength.ZERO_TINY, HornLength.ZERO_TINY, Util.newArrayListOfValues(HornType.NONE),
			PenisType.RAT_MORPH, 17, PenetrationGirth.TWO_AVERAGE,
	...
	public static AbstractRacialBody BAT_MORPH = new AbstractRacialBody(
			...
			BodyMaterial.FLESH,
			HornLength.ZERO_TINY, HornLength.ZERO_TINY, Util.newArrayListOfValues(HornType.NONE),
			PenisType.BAT_MORPH, 15, PenetrationGirth.TWO_AVERAGE, TesticleSize.TWO_AVERAGE, 2, CumProduction.THREE_AVERAGE,
	...
	public static AbstractRacialBody HARPY = new AbstractRacialBody(
			...
			BodyMaterial.FLESH,
			HornLength.ZERO_TINY, HornLength.ZERO_TINY, Util.newArrayListOfValues(HornType.NONE),
			PenisType.AVIAN, 7, PenetrationGirth.ONE_SLENDER, TesticleSize.ZERO_VESTIGIAL, 2, CumProduction.ONE_TRICKLE,
