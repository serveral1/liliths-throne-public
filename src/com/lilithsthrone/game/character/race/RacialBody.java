...
public class RacialBody {
	...
	public static AbstractRacialBody COW_MORPH = new AbstractRacialBody(
			...
			PenisType.COW_MORPH, 27, PenetrationGirth.FOUR_GIRTHY, TesticleSize.FOUR_HUGE, 2, CumProduction.FIVE_HUGE,
	...
	public static AbstractRacialBody FOX_MORPH = new AbstractRacialBody(
			...
			HornLength.ZERO_TINY, HornLength.ZERO_TINY, Util.newArrayListOfValues(HornType.NONE),
			PenisType.FOX_MORPH, 17, PenetrationGirth.THREE_AVERAGE, TesticleSize.TWO_AVERAGE, 2, CumProduction.FOUR_LARGE,
	...
	public static AbstractRacialBody CAT_MORPH = new AbstractRacialBody(
			...
			HornLength.ZERO_TINY, HornLength.ZERO_TINY, Util.newArrayListOfValues(HornType.NONE),
			PenisType.CAT_MORPH, 15, PenetrationGirth.THREE_AVERAGE, TesticleSize.TWO_AVERAGE, 2, CumProduction.THREE_AVERAGE,
	...
	public static AbstractRacialBody REINDEER_MORPH = new AbstractRacialBody(
			...
			PenisType.REINDEER_MORPH, 28, PenetrationGirth.FOUR_GIRTHY, TesticleSize.THREE_LARGE, 2, CumProduction.THREE_AVERAGE,
	...
	public static AbstractRacialBody ALLIGATOR_MORPH = new AbstractRacialBody(
			...
			HornLength.ZERO_TINY, HornLength.ZERO_TINY, Util.newArrayListOfValues(HornType.NONE),
		    PenisType.ALLIGATOR_MORPH, 21, PenetrationGirth.FOUR_GIRTHY, TesticleSize.FOUR_HUGE, 2, CumProduction.FIVE_HUGE,
	...
	public static AbstractRacialBody SQUIRREL_MORPH = new AbstractRacialBody(
			...
			HornLength.ZERO_TINY, HornLength.ZERO_TINY, Util.newArrayListOfValues(HornType.NONE),
			PenisType.SQUIRREL_MORPH, 20, PenetrationGirth.FOUR_GIRTHY, TesticleSize.THREE_LARGE, 2, CumProduction.FOUR_LARGE,
	...
	public static AbstractRacialBody RAT_MORPH = new AbstractRacialBody(
			...
			HornLength.ZERO_TINY, HornLength.ZERO_TINY, Util.newArrayListOfValues(HornType.NONE),
			PenisType.RAT_MORPH, 17, PenetrationGirth.THREE_AVERAGE,
	...
	public static AbstractRacialBody BAT_MORPH = new AbstractRacialBody(
			...
			HornLength.ZERO_TINY, HornLength.ZERO_TINY, Util.newArrayListOfValues(HornType.NONE),
			PenisType.BAT_MORPH, 15, PenetrationGirth.THREE_AVERAGE, TesticleSize.TWO_AVERAGE, 2, CumProduction.THREE_AVERAGE,
	...
	public static AbstractRacialBody HARPY = new AbstractRacialBody(
			...
			HornLength.ZERO_TINY, HornLength.ZERO_TINY, Util.newArrayListOfValues(HornType.NONE),
			PenisType.HARPY, 7, PenetrationGirth.TWO_NARROW, TesticleSize.ONE_TINY, 2, CumProduction.TWO_SMALL_AMOUNT,
