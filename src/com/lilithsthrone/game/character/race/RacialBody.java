...
public class RacialBody {
	...
	public static AbstractRacialBody HUMAN = new AbstractRacialBody(
			...
			CupSize.C, 1, Lactation.ZERO_NONE, Capacity.ZERO_IMPENETRABLE, OrificeDepth.TWO_AVERAGE, OrificeElasticity.THREE_FLEXIBLE, OrificePlasticity.THREE_RESILIENT,
				NippleSize.TWO_BIG, NippleShape.NORMAL, AreolaeSize.TWO_BIG, 1,
			175, 25, BodySize.TWO_AVERAGE.getMedianValue(), Muscle.TWO_TONED.getMedianValue(),
			165, 75, BodySize.TWO_AVERAGE.getMinimumValue(), Muscle.ONE_LIGHTLY_MUSCLED.getMinimumValue(),
			EarType.HUMAN,
			EyeType.HUMAN,
			...
			PenisType.HUMAN, 16, PenetrationGirth.THREE_AVERAGE, TesticleSize.TWO_AVERAGE, 2, CumProduction.THREE_AVERAGE,
	...
	public static AbstractRacialBody ANGEL = new AbstractRacialBody(
			Util.newArrayListOfValues(AntennaType.NONE),
			ArmType.ANGEL, 1,
			AssType.ANGEL, AssSize.TWO_SMALL, AssSize.FOUR_LARGE, Wetness.ZERO_DRY, Capacity.ONE_EXTREMELY_TIGHT, OrificeDepth.TWO_AVERAGE, OrificeElasticity.THREE_FLEXIBLE, OrificePlasticity.THREE_RESILIENT,
			...
			CupSize.C, 1, Lactation.ZERO_NONE, Capacity.ZERO_IMPENETRABLE, OrificeDepth.TWO_AVERAGE, OrificeElasticity.THREE_FLEXIBLE, OrificePlasticity.THREE_RESILIENT,
				NippleSize.TWO_BIG, NippleShape.NORMAL, AreolaeSize.TWO_BIG, 1,
			180, 25, BodySize.THREE_LARGE.getMedianValue(), Muscle.FOUR_RIPPED.getMedianValue(),
			180, 95, BodySize.ONE_SLENDER.getMedianValue(), Muscle.FOUR_RIPPED.getMedianValue(),
			EarType.ANGEL,
			EyeType.ANGEL,
			...
			HornLength.ZERO_TINY, HornLength.ZERO_TINY, Util.newArrayListOfValues(HornType.NONE),
			PenisType.ANGEL, 20, PenetrationGirth.THREE_AVERAGE,TesticleSize.THREE_LARGE, 2, CumProduction.SIX_EXTREME,
			Util.newArrayListOfValues(TailType.NONE),
			TentacleType.NONE,
	...
	public static AbstractRacialBody DEMON = new AbstractRacialBody(
			...
			CupSize.C, 1, Lactation.ZERO_NONE, Capacity.ZERO_IMPENETRABLE, OrificeDepth.THREE_SPACIOUS, OrificeElasticity.THREE_FLEXIBLE, OrificePlasticity.THREE_RESILIENT,
				NippleSize.TWO_BIG, NippleShape.NORMAL, AreolaeSize.TWO_BIG, 1,
			185, 10, BodySize.TWO_AVERAGE.getMedianValue(), Muscle.THREE_MUSCULAR.getMedianValue(),
			175, 90, BodySize.TWO_AVERAGE.getMedianValue(), Muscle.THREE_MUSCULAR.getMedianValue(),
			...
			PenisType.DEMON_COMMON, 25, PenetrationGirth.FOUR_GIRTHY, TesticleSize.THREE_LARGE, 2, CumProduction.SEVEN_MONSTROUS,
	...
	public static AbstractRacialBody COW_MORPH = new AbstractRacialBody(
			...
			190, 30, BodySize.FOUR_HUGE.getMedianValue(), Muscle.THREE_MUSCULAR.getMedianValue(),
			180, 70, BodySize.THREE_LARGE.getMedianValue(), Muscle.TWO_TONED.getMedianValue(),
			EarType.COW_MORPH,
			EyeType.COW_MORPH, 
			...
			PenisType.COW_MORPH, 26, PenetrationGirth.FOUR_GIRTHY, TesticleSize.FOUR_HUGE, 2, CumProduction.FIVE_HUGE,
	...
	public static AbstractRacialBody DOG_MORPH = new AbstractRacialBody(
			...
			HornLength.ZERO_TINY, HornLength.ZERO_TINY, Util.newArrayListOfValues(HornType.NONE),
			PenisType.DOG_MORPH, 19, PenetrationGirth.THREE_AVERAGE, TesticleSize.THREE_LARGE, 2, CumProduction.FOUR_LARGE,
	...
	public static AbstractRacialBody FOX_MORPH = new AbstractRacialBody(
			...
			CupSize.AA, 2, Lactation.ZERO_NONE, Capacity.ZERO_IMPENETRABLE, OrificeDepth.TWO_AVERAGE, OrificeElasticity.THREE_FLEXIBLE, OrificePlasticity.THREE_RESILIENT,
				NippleSize.TWO_BIG, NippleShape.NORMAL, AreolaeSize.TWO_BIG, 1,
			170, 15, BodySize.TWO_AVERAGE.getMedianValue(), Muscle.ONE_LIGHTLY_MUSCLED.getMedianValue(),
			160, 75, BodySize.TWO_AVERAGE.getMedianValue(), Muscle.ONE_LIGHTLY_MUSCLED.getMinimumValue(),
			EarType.FOX_MORPH,
			EyeType.FOX_MORPH,
			...
			HornLength.ZERO_TINY, HornLength.ZERO_TINY, Util.newArrayListOfValues(HornType.NONE),
			PenisType.FOX_MORPH, 18, PenetrationGirth.THREE_AVERAGE, TesticleSize.TWO_AVERAGE, 2, CumProduction.FOUR_LARGE,
	...
	public static AbstractRacialBody WOLF_MORPH = new AbstractRacialBody(
			...
			HornLength.ZERO_TINY, HornLength.ZERO_TINY, Util.newArrayListOfValues(HornType.NONE),
			PenisType.WOLF_MORPH, 22, PenetrationGirth.FOUR_GIRTHY, TesticleSize.THREE_LARGE, 2, CumProduction.FIVE_HUGE,
	...
	public static AbstractRacialBody CAT_MORPH = new AbstractRacialBody(
			...
			HornLength.ZERO_TINY, HornLength.ZERO_TINY, Util.newArrayListOfValues(HornType.NONE),
			PenisType.CAT_MORPH, 16, PenetrationGirth.THREE_AVERAGE, TesticleSize.TWO_AVERAGE, 2, CumProduction.THREE_AVERAGE,
	...
	public static AbstractRacialBody HORSE_MORPH = new AbstractRacialBody(
			...
			PenisType.EQUINE, 35, PenetrationGirth.FIVE_THICK, TesticleSize.FOUR_HUGE, 2, CumProduction.FIVE_HUGE, Util.newArrayListOfValues(TailType.HORSE_MORPH),
			TentacleType.NONE,
	...
	public static AbstractRacialBody REINDEER_MORPH = new AbstractRacialBody(
			...
			PenisType.REINDEER_MORPH, 27, PenetrationGirth.FOUR_GIRTHY, TesticleSize.THREE_LARGE, 2, CumProduction.THREE_AVERAGE,
	...
	public static AbstractRacialBody ALLIGATOR_MORPH = new AbstractRacialBody(
			...
			HornLength.ZERO_TINY, HornLength.ZERO_TINY, Util.newArrayListOfValues(HornType.NONE),
		    PenisType.ALLIGATOR_MORPH, 20, PenetrationGirth.FOUR_GIRTHY, TesticleSize.FOUR_HUGE, 2, CumProduction.FIVE_HUGE,
	...
	public static AbstractRacialBody SQUIRREL_MORPH = new AbstractRacialBody(
			...
			CupSize.AA, 2, Lactation.ZERO_NONE, Capacity.ZERO_IMPENETRABLE, OrificeDepth.TWO_AVERAGE, OrificeElasticity.THREE_FLEXIBLE, OrificePlasticity.THREE_RESILIENT,
				NippleSize.TWO_BIG, NippleShape.NORMAL, AreolaeSize.TWO_BIG, 1,
			165, 35, BodySize.TWO_AVERAGE.getMedianValue(), Muscle.THREE_MUSCULAR.getMedianValue(),
			155, 85, BodySize.TWO_AVERAGE.getMedianValue(), Muscle.TWO_TONED.getMedianValue(),
			...
			HornLength.ZERO_TINY, HornLength.ZERO_TINY, Util.newArrayListOfValues(HornType.NONE),
			PenisType.SQUIRREL_MORPH, 18, PenetrationGirth.FOUR_GIRTHY, TesticleSize.THREE_LARGE, 2, CumProduction.FOUR_LARGE,
	...
	public static AbstractRacialBody RAT_MORPH = new AbstractRacialBody(
			...
			HornLength.ZERO_TINY, HornLength.ZERO_TINY, Util.newArrayListOfValues(HornType.NONE),
			PenisType.RAT_MORPH, 18, PenetrationGirth.THREE_AVERAGE,
	...
	public static AbstractRacialBody RABBIT_MORPH = new AbstractRacialBody(
			...
			HornLength.ZERO_TINY, HornLength.ZERO_TINY, Util.newArrayListOfValues(HornType.NONE),
			PenisType.RABBIT_MORPH, 16, PenetrationGirth.THREE_AVERAGE, TesticleSize.TWO_AVERAGE, 2, CumProduction.THREE_AVERAGE,
	...
	public static AbstractRacialBody BAT_MORPH = new AbstractRacialBody(
			...
			HornLength.ZERO_TINY, HornLength.ZERO_TINY, Util.newArrayListOfValues(HornType.NONE),
			PenisType.BAT_MORPH, 17, PenetrationGirth.THREE_AVERAGE, TesticleSize.TWO_AVERAGE, 2, CumProduction.THREE_AVERAGE,
	...
	public static AbstractRacialBody HARPY = new AbstractRacialBody(
			Util.newArrayListOfValues(AntennaType.NONE),
			ArmType.HARPY, 1,
			AssType.HARPY, AssSize.TWO_SMALL, AssSize.FOUR_LARGE, Wetness.ZERO_DRY, Capacity.ONE_EXTREMELY_TIGHT, OrificeDepth.TWO_AVERAGE, OrificeElasticity.THREE_FLEXIBLE, OrificePlasticity.THREE_RESILIENT,
			...
			CupSize.TRAINING_A, 1, Lactation.ZERO_NONE, Capacity.ZERO_IMPENETRABLE, OrificeDepth.TWO_AVERAGE, OrificeElasticity.THREE_FLEXIBLE, OrificePlasticity.THREE_RESILIENT,
				NippleSize.ZERO_TINY, NippleShape.NORMAL, AreolaeSize.ZERO_TINY, 1,
			160, 65, BodySize.ONE_SLENDER.getMedianValue(), Muscle.TWO_TONED.getMedianValue(),
			150, 95, BodySize.ONE_SLENDER.getMedianValue(), Muscle.ONE_LIGHTLY_MUSCLED.getMedianValue(),
			EarType.HARPY,
			EyeType.HARPY,
			...
			HornLength.ZERO_TINY, HornLength.ZERO_TINY, Util.newArrayListOfValues(HornType.NONE),
			PenisType.HARPY, 14, PenetrationGirth.TWO_NARROW, TesticleSize.ONE_TINY, 2, CumProduction.TWO_SMALL_AMOUNT,
