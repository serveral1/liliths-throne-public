...
public class RacialBody {
	...
	public static AbstractRacialBody DEMON = new AbstractRacialBody(
			...
			PenisType.DEMON_COMMON, 25, PenetrationGirth.FOUR_THICK, TesticleSize.THREE_LARGE, 2, CumProduction.SEVEN_MONSTROUS,
	...
	public static AbstractRacialBody COW_MORPH = new AbstractRacialBody(
			...
			PenisType.COW_MORPH, 27, PenetrationGirth.FOUR_THICK, TesticleSize.FOUR_HUGE, 2, CumProduction.FIVE_HUGE,
	...
	public static AbstractRacialBody WOLF_MORPH = new AbstractRacialBody(
			...
			BodyMaterial.FLESH,
			HornLength.ZERO_TINY, HornLength.ZERO_TINY, Util.newArrayListOfValues(HornType.NONE),
			PenisType.WOLF_MORPH, 22, PenetrationGirth.FOUR_THICK, TesticleSize.THREE_LARGE, 2, CumProduction.FIVE_HUGE,
	...
	public static AbstractRacialBody HORSE_MORPH = new AbstractRacialBody(
			...
			PenisType.EQUINE, 35, PenetrationGirth.FIVE_FAT, TesticleSize.FOUR_HUGE, 2, CumProduction.FIVE_HUGE, Util.newArrayListOfValues(TailType.HORSE_MORPH),
			TentacleType.NONE,
	...
	public static AbstractRacialBody REINDEER_MORPH = new AbstractRacialBody(
			...
			PenisType.REINDEER_MORPH, 28, PenetrationGirth.FOUR_THICK, TesticleSize.THREE_LARGE, 2, CumProduction.THREE_AVERAGE,
	...
	public static AbstractRacialBody ALLIGATOR_MORPH = new AbstractRacialBody(
		    ...
		    BodyMaterial.FLESH,
			HornLength.ZERO_TINY, HornLength.ZERO_TINY, Util.newArrayListOfValues(HornType.NONE),
		    PenisType.ALLIGATOR_MORPH, 21, PenetrationGirth.FOUR_THICK, TesticleSize.FOUR_HUGE, 2, CumProduction.FIVE_HUGE,
	...
	public static AbstractRacialBody SQUIRREL_MORPH = new AbstractRacialBody(
			...
			BodyMaterial.FLESH,
			HornLength.ZERO_TINY, HornLength.ZERO_TINY, Util.newArrayListOfValues(HornType.NONE),
			PenisType.SQUIRREL_MORPH, 20, PenetrationGirth.FOUR_THICK, TesticleSize.THREE_LARGE, 2, CumProduction.FOUR_LARGE,
