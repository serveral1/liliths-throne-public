...
public class RacialBody {
	...
	public static AbstractRacialBody COW_MORPH = new AbstractRacialBody(
			...
			PenisType.BOVINE, 27, PenetrationGirth.FOUR_THICK, TesticleSize.THREE_LARGE, 2, CumProduction.FIVE_HUGE,
	...
	public static AbstractRacialBody DOG_MORPH = new AbstractRacialBody(
			...
			BodyMaterial.FLESH,
			HornLength.ZERO_TINY, HornLength.ZERO_TINY, Util.newArrayListOfValues(HornType.NONE),
			PenisType.CANINE, 19, PenetrationGirth.THREE_AVERAGE, TesticleSize.THREE_LARGE, 2, CumProduction.FOUR_LARGE,
	...
	public static AbstractRacialBody FOX_MORPH = new AbstractRacialBody(
			...
			BodyMaterial.FLESH,
			HornLength.ZERO_TINY, HornLength.ZERO_TINY, Util.newArrayListOfValues(HornType.NONE),
			PenisType.VULPINE, 17, PenetrationGirth.THREE_AVERAGE, TesticleSize.TWO_AVERAGE, 2, CumProduction.FOUR_LARGE,
	...
	public static AbstractRacialBody WOLF_MORPH = new AbstractRacialBody(
			...
			BodyMaterial.FLESH,
			HornLength.ZERO_TINY, HornLength.ZERO_TINY, Util.newArrayListOfValues(HornType.NONE),
			PenisType.LUPINE, 22, PenetrationGirth.FOUR_THICK, TesticleSize.THREE_LARGE, 2, CumProduction.FIVE_HUGE,
	...
	public static AbstractRacialBody CAT_MORPH = new AbstractRacialBody(
			...
			BodyMaterial.FLESH,
			HornLength.ZERO_TINY, HornLength.ZERO_TINY, Util.newArrayListOfValues(HornType.NONE),
			PenisType.FELINE, 15, PenetrationGirth.THREE_AVERAGE, TesticleSize.TWO_AVERAGE, 2, CumProduction.THREE_AVERAGE,
	...
	public static AbstractRacialBody SQUIRREL_MORPH = new AbstractRacialBody(
			...
			BodyMaterial.FLESH,
			HornLength.ZERO_TINY, HornLength.ZERO_TINY, Util.newArrayListOfValues(HornType.NONE),
			PenisType.SQUIRREL, 20, PenetrationGirth.FOUR_THICK, TesticleSize.THREE_LARGE, 2, CumProduction.FOUR_LARGE,
	...
	public static AbstractRacialBody HARPY = new AbstractRacialBody(
			...
			BodyMaterial.FLESH,
			HornLength.ZERO_TINY, HornLength.ZERO_TINY, Util.newArrayListOfValues(HornType.NONE),
			PenisType.AVIAN, 7, PenetrationGirth.TWO_NARROW, TesticleSize.ZERO_VESTIGIAL, 2, CumProduction.ONE_TRICKLE,
