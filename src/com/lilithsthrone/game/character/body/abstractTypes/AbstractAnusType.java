...
public abstract class AbstractAnusType implements BodyPartTypeInterface {
	...
	public String getNameSingular(GameCharacter gc) {
		if(names==null || names.isEmpty()) {
			return UtilText.returnStringAtRandom("asshole", "back door", "rear entrance", "butthole");
		}
	...
	public String getNamePlural(GameCharacter gc) {
		if(namesPlural==null || namesPlural.isEmpty()) {
			return UtilText.returnStringAtRandom("assholes", "back doors", "rear entrances", "buttholes");
		}
