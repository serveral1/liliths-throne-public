...
public enum PenisLength {
	...
	TWO_AVERAGE("average-sized", 10, 18, PresetColour.GENERIC_SIZE_THREE),

	/**Average size for a wolf morph. (8-11 inches)*/
	THREE_LARGE("large", 18, 29, PresetColour.GENERIC_SIZE_FOUR),

	/**Average size for a horse morph. (12-15 inches)*/
	FOUR_HUGE("huge", 29, 39, PresetColour.GENERIC_SIZE_FIVE),

	/**Straying into the bounds of "world record for a human". Large for a horse morph. (16-19 inches)*/
	FIVE_ENORMOUS("enormous", 39, 48, PresetColour.GENERIC_SIZE_SIX),

	/**This is just ridiculous... World record for a horse-morph. (20-23 inches)*/
	SIX_GIGANTIC("gigantic", 48, 58, PresetColour.GENERIC_SIZE_SEVEN),

	/**And this is for "extreme proportion" content. (24-40 inches)*/
	SEVEN_STALLION("stallion-sized", 58, 100, PresetColour.GENERIC_SIZE_EIGHT);
