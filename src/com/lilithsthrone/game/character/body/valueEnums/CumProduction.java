...
public enum CumProduction {
	...
	ONE_TRICKLE("drop", "a few drops of", 1, 5, 75, Wetness.ONE_SLIGHTLY_MOIST, PresetColour.GENERIC_SIZE_TWO, 0),
	
	/** This is significantly less than an average amount of cum that a human male produces when orgasming. */
	TWO_SMALL_AMOUNT("trickle", "a trickle of", 5, 10, 50, Wetness.TWO_MOIST, PresetColour.GENERIC_SIZE_THREE, 0),
	
	/** This is an average amount of cum that a human male produces when orgasming. */
	THREE_AVERAGE("average", "an average amount of", 10, 25, 25, Wetness.THREE_WET, PresetColour.GENERIC_SIZE_FOUR, 0),
	
	/** This is a large amount of cum, although relatively speaking, it's not a huge quantity of liquid. */
	FOUR_LARGE("large", "a large amount of", 25, 100, 10, Wetness.FOUR_SLIMY, PresetColour.GENERIC_SIZE_FIVE, 1),
	
	/** This is a very large amount of cum. (About a quarter of a can of coke.)*/
	FIVE_HUGE("huge", "a huge amount of", 100, 250, 5, Wetness.FIVE_SLOPPY, PresetColour.GENERIC_SIZE_SIX, 2),
	
	/** This and SEVEN_MONSTROUS are a bit ridiculous, and should only be used as part of "extreme proportion" content. */
	SIX_EXTREME("extreme", "an extreme amount of", 250, 5000, 0, Wetness.SIX_SOPPING_WET, PresetColour.GENERIC_SIZE_SEVEN, 4),
	
	/** This and SIX_EXTREME are a bit ridiculous, and should only be used as part of "extreme proportion" content. */
	SEVEN_MONSTROUS("monstrous", "a monstrous amount of", 5000, 10000, 0, Wetness.SEVEN_DROOLING, PresetColour.GENERIC_SIZE_EIGHT, 8);
