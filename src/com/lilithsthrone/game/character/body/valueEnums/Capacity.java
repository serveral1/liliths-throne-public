...
public enum Capacity {
	...
	ONE_EXTREMELY_TIGHT("very tight", "tight", 1f, 2f, PresetColour.GENERIC_SIZE_TWO, false),
	
	TWO_TIGHT("somewhat tight", "tight", 2f, 4f, PresetColour.GENERIC_SIZE_THREE, false),
	
	THREE_SLIGHTLY_LOOSE("slightly loose", "loose", 4f, 8f, PresetColour.GENERIC_SIZE_FOUR, false),
	
	FOUR_LOOSE("loose", "loose", 8f, 12f, PresetColour.GENERIC_SIZE_FIVE, false),
	
	FIVE_ROOMY("very loose", "loose", 12f, 16f, PresetColour.GENERIC_SIZE_SIX, true) {
		@Override
	...
	SIX_STRETCHED_OPEN("stretched open", "gaping", 16f, 20f, PresetColour.GENERIC_SIZE_SEVEN, true) {
		@Override
		public String getDescriptor() {
			if(!Main.game.isGapeContentEnabled()) {
				return FOUR_LOOSE.getDescriptor();
	...
	SEVEN_GAPING("gaping wide", "gaping", 20f, 24f, PresetColour.GENERIC_SIZE_EIGHT, true) {
		@Override
		public String getDescriptor() {
			if(!Main.game.isGapeContentEnabled()) {
				return FOUR_LOOSE.getDescriptor();
