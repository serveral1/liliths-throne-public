...
public enum Capacity {
	...
	ZERO_IMPENETRABLE("extremely tight", "tight", 0f, 2.5f, PresetColour.GENERIC_SIZE_ONE),
	
	ONE_EXTREMELY_TIGHT("tight", "tight", 2.5f, 5f, PresetColour.GENERIC_SIZE_TWO),
	
	TWO_TIGHT("somewhat tight", "tight", 5f, 7.5f, PresetColour.GENERIC_SIZE_THREE),
	
	THREE_SLIGHTLY_LOOSE("slightly loose", "loose", 7.5f, 10f, PresetColour.GENERIC_SIZE_FOUR),
	
	FOUR_LOOSE("loose", "loose", 10f, 12.5f, PresetColour.GENERIC_SIZE_FIVE),
	
	FIVE_ROOMY("very loose", "loose", 12.5f, 15f, PresetColour.GENERIC_SIZE_SIX) {
		@Override
	...
	SIX_STRETCHED_OPEN("stretched open", "gaping", 15f, 20f, PresetColour.GENERIC_SIZE_SEVEN) {
		@Override
		public String getDescriptor() {
			if(!Main.game.isGapeContentEnabled()) {
				return FOUR_LOOSE.getDescriptor();
